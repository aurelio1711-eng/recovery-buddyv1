...
Comprehensive coding standards skill for OpenCode — covers code quality principles, TypeScript/JavaScript standards, React best practices, API design, file organization, and performance patterns. Triggered when the user mentions coding standards, best practices, code review, refactoring, naming conventions, or code quality.
...
11. [Code Smell Detection](#code-smell-detection)
12. [Checklists](#checklists)
13. [OpenCode Usage Examples](#opencode-usage-examples)
...
- **Keywords**: coding standards, best practices, code review, refactor, naming conventions, code quality, clean code, code smells, anti-patterns, lint
- **Contexts**: Writing new code, reviewing pull requests, refactoring existing code, onboarding new developers, enforcing code style
- **Frameworks**: TypeScript, JavaScript, React, Node.js, Next.js, Zod
...
2. **Identify** violations against the standards below.
3. **Classify** issues by severity (critical, major, minor).
4. **Refactor** following the patterns in this skill.
5. **Verify** with lint and type-check commands.
...
- [ ] No use of `any` type
- [ ] Immutability patterns (spread operator, no direct mutation)
- [ ] Comprehensive error handling with try/catch
- [ ] Parallel async operations with `Promise.all` where applicable
- [ ] Input validation with Zod or equivalent schema
...
- [ ] Placed in correct directory under `src/`

### Refactoring Checklist
- [ ] Identify code smells (long functions, deep nesting, magic numbers)
- [ ] Extract reusable logic into utilities or hooks
- [ ] Ensure no regressions with existing tests
...
```
Add comprehensive error handling to the fetchMarketData function in src/api/markets.ts following our coding standards.
```
